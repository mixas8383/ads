	...
	function duplicate($contentid) {
		...
		if ($images != null) {
			foreach($images as $key => $image) {
				if (file_exists(JPATH_ROOT."/images/com_adsmanager/ads/".$image->image)) {
					JFile::copy(JPATH_ROOT."/images/com_adsmanager/ads/".$image->image,
					JPATH_ROOT."/images/com_adsmanager/ads/1_".$image->image);
				}
				if (file_exists(JPATH_ROOT."/images/com_adsmanager/ads/".$image->thumbnail)) {
					JFile::copy(JPATH_ROOT."/images/com_adsmanager/ads/".$image->thumbnail,
					JPATH_ROOT."/images/com_adsmanager/ads/1_".$image->thumbnail);
				}
				if (file_exists(JPATH_ROOT."/images/com_adsmanager/ads/".$image->medium)) {
					JFile::copy(JPATH_ROOT."/images/com_adsmanager/ads/".$image->medium,
					JPATH_ROOT."/images/com_adsmanager/ads/1_".$image->medium);
				}
