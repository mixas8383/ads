...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2016 at 11:41 PM
...
--
-- Table structure for table `yy4cv_adsmanager_adcat`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_adcat` (
...
--
-- Table structure for table `yy4cv_adsmanager_ads`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_ads` (
...
--
-- Table structure for table `yy4cv_adsmanager_categories`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `yy4cv_adsmanager_categories`
--

INSERT INTO `yy4cv_adsmanager_categories` (`id`, `parent`, `name`, `description`, `metadata_description`, `metadata_keywords`, `ordering`, `published`, `limitads`, `usergroupsread`, `usergroupswrite`) VALUES
(1, 0, 'Category 1', NULL, NULL, NULL, 0, 1, -1, NULL, NULL),
(2, 0, 'Category 2', NULL, NULL, NULL, 0, 1, -1, NULL, NULL),
(3, 1, 'SubCat1', NULL, NULL, NULL, 0, 1, -1, NULL, NULL),
(4, 1, 'SubCat2', NULL, NULL, NULL, 0, 1, -1, NULL, NULL),
(5, 1, 'SubCat3', NULL, NULL, NULL, 0, 1, -1, NULL, NULL),
(6, 2, 'SubCat4', NULL, NULL, NULL, 0, 1, -1, NULL, NULL),
(7, 2, 'SubCat5', NULL, NULL, NULL, 0, 1, -1, NULL, NULL),
(8, 2, 'SubCat6', NULL, NULL, NULL, 0, 1, -1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_adsmanager_columns`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_columns` (
...
--
-- Dumping data for table `yy4cv_adsmanager_columns`
--

INSERT INTO `yy4cv_adsmanager_columns` (`id`, `name`, `ordering`, `catsid`, `published`) VALUES
...
--
-- Table structure for table `yy4cv_adsmanager_config`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_config` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_adsmanager_fields`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_fields` (
...
--
-- Dumping data for table `yy4cv_adsmanager_fields`
--

INSERT INTO `yy4cv_adsmanager_fields` (`fieldid`, `name`, `title`, `display_title`, `description`, `type`, `maxlength`, `size`, `required`, `ordering`, `cols`, `rows`, `link_text`, `link_image`, `columnid`, `columnorder`, `pos`, `posorder`, `profile`, `cb_field`, `cbfieldvalues`, `editable`, `searchable`, `sort`, `sort_direction`, `catsid`, `options`, `published`) VALUES
...
(10, 'ad_price', 'ADSMANAGER_FORM_AD_PRICE', 0, '', 'price', 10, 7, 1, 9, 0, 0, '', '', 2, 0, 4, 1, 0, -1, -1, 1, 1, 1, 'DESC', ',-1,', '{"currency_symbol":"\\u20ac","currency_position":"after","currency_number_decimals":"2","currency_decimal_separator":".","currency_thousands_separator":" "}', 1);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_adsmanager_field_values`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_field_values` (
...
--
-- Dumping data for table `yy4cv_adsmanager_field_values`
--

INSERT INTO `yy4cv_adsmanager_field_values` (`fieldvalueid`, `fieldid`, `fieldtitle`, `fieldvalue`, `ordering`, `sys`) VALUES
...
--
-- Table structure for table `yy4cv_adsmanager_pending_ads`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_pending_ads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_adsmanager_pending_mails`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_pending_mails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_adsmanager_positions`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_positions` (
...
--
-- Dumping data for table `yy4cv_adsmanager_positions`
--

INSERT INTO `yy4cv_adsmanager_positions` (`id`, `name`, `title`) VALUES
...
--
-- Table structure for table `yy4cv_adsmanager_profile`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_profile` (
...
--
-- Dumping data for table `yy4cv_adsmanager_profile`
--

INSERT INTO `yy4cv_adsmanager_profile` (`userid`, `name`, `ad_city`, `email`, `ad_zip`, `ad_phone`) VALUES
(86, '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_adsmanager_searchmodule_config`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_searchmodule_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `yy4cv_adsmanager_searchmodule_config`
--

INSERT INTO `yy4cv_adsmanager_searchmodule_config` (`id`, `params`) VALUES
(1, '');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_adsmanager_tags`
--

CREATE TABLE IF NOT EXISTS `yy4cv_adsmanager_tags` (
  `type` varchar(50) NOT NULL DEFAULT '',
...
--
-- Table structure for table `yy4cv_assets`
--

CREATE TABLE IF NOT EXISTS `yy4cv_assets` (
...
--
-- Dumping data for table `yy4cv_assets`
--

INSERT INTO `yy4cv_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(54, 1, 109, 110, 1, 'com_adsmanager', 'Adsmanager', '{}'),
(55, 18, 70, 71, 2, 'com_modules.module.87', 'mod_adsmanager_ads', '{}'),
(56, 18, 72, 73, 2, 'com_modules.module.88', 'mod_adsmanager_menu', '{}'),
(57, 18, 74, 75, 2, 'com_modules.module.89', 'mod_adsmanager_search', '{}'),
(58, 18, 76, 77, 2, 'com_modules.module.90', 'mod_adsmanager_table', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_associations`
--

CREATE TABLE IF NOT EXISTS `yy4cv_associations` (
...
--
-- Table structure for table `yy4cv_banners`
--

CREATE TABLE IF NOT EXISTS `yy4cv_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_banner_clients`
--

CREATE TABLE IF NOT EXISTS `yy4cv_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `yy4cv_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `yy4cv_banner_tracks` (
...
--
-- Table structure for table `yy4cv_categories`
--

CREATE TABLE IF NOT EXISTS `yy4cv_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `yy4cv_categories`
--

INSERT INTO `yy4cv_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `yy4cv_contact_details`
--

CREATE TABLE IF NOT EXISTS `yy4cv_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `yy4cv_content`
--

CREATE TABLE IF NOT EXISTS `yy4cv_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Table structure for table `yy4cv_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `yy4cv_contentitem_tag_map` (
...
--
-- Table structure for table `yy4cv_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `yy4cv_content_frontpage` (
...
--
-- Table structure for table `yy4cv_content_rating`
--

CREATE TABLE IF NOT EXISTS `yy4cv_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `yy4cv_content_types`
--

CREATE TABLE IF NOT EXISTS `yy4cv_content_types` (
...
--
-- Dumping data for table `yy4cv_content_types`
--

INSERT INTO `yy4cv_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `yy4cv_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `yy4cv_core_log_searches` (
...
--
-- Table structure for table `yy4cv_extensions`
--

CREATE TABLE IF NOT EXISTS `yy4cv_extensions` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10014 ;

--
-- Dumping data for table `yy4cv_extensions`
--

INSERT INTO `yy4cv_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(11, 'com_languages', 'component', 'com_languages', '', 1, 1, 1, 1, '{"name":"com_languages","type":"component","creationDate":"2006","author":"Joomla! Project","copyright":"(C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_LANGUAGES_XML_DESCRIPTION","group":""}', '{"administrator":"en-GB","site":"ru-RU"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"a9d5d55772211c09bad38b65c41beb47"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1460918200}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1460918234,"unique_id":"1288ebb847164ef2163010f8ac091e3378b3a137","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10003, 'Adsmanager', 'component', 'com_adsmanager', '', 1, 1, 0, 0, '{"name":"Adsmanager","type":"component","creationDate":"January 2015","author":"TomPAP (Juloa.com)","copyright":"\\n\\t\\tCopyright (C) 2010-2014 Juloa. All rights reserved.\\n\\t","authorEmail":"support@juloa.com","authorUrl":"www.Juloa.com","version":"3.0.3","description":"Classifield Ads","group":"","filename":"aaa_adsmanager"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10004, 'mod_adsmanager_ads', 'module', 'mod_adsmanager_ads', '', 0, 1, 0, 0, '{"name":"mod_adsmanager_ads","type":"module","creationDate":"January 2015","author":"Thomas Papin","copyright":"","authorEmail":"support@juloa.com","authorUrl":"www.Juloa.com","version":"3.0.3","description":"Displays the latest \\/ random \\/ popular ads of AdsManager","group":"","filename":"mod_adsmanager_ads"}', '{"random":"0","nb_ads":"3","nb_ads_by_row":"3","align":"hor","image":"1","imagesize":"small","displaycategory":"1","displaydate":"1","catselect":"","rootid":"","field1":"","field2":"","field3":"","field4":"","field5":"","cache":"1","cache_time":"900","cachemode":"static"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10005, 'mod_adsmanager_menu', 'module', 'mod_adsmanager_menu', '', 0, 1, 0, 0, '{"name":"mod_adsmanager_menu","type":"module","creationDate":"January 2015","author":"Thomas Papin","copyright":"","authorEmail":"support@juloa.com","authorUrl":"www.Juloa.com","version":"3.0.3","description":"Displays the AdsManager Menu","group":"","filename":"mod_adsmanager_menu"}', '{"displaynumads":"1","displayhome":"1","displaywritead":"1","displayprofile":"1","displaymyads":"1","displayrules":"1","displayallads":"1","displaycategories":"1","displayfavorites":"1","displayseparators":"1","rootid":"","cache":"0","cache_time":"900","cachemode":"static"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10006, 'mod_adsmanager_search', 'module', 'mod_adsmanager_search', '', 0, 1, 0, 0, '{"name":"mod_adsmanager_search","type":"module","creationDate":"January 2015","author":"Thomas Papin","copyright":"","authorEmail":"support@juloa.com","authorUrl":"www.Juloa.com","version":"3.0.3","description":"AdsManager Search Module","group":"","filename":"mod_adsmanager_search"}', '{"advanced_search":"1","search_by_cat":"1","display_cat_label":"0","search_by_text":"1","field1":"","field2":"","field3":"","field4":"","field5":"","type":"table","rootid":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10007, 'mod_adsmanager_table', 'module', 'mod_adsmanager_table', '', 0, 1, 0, 0, '{"name":"mod_adsmanager_table","type":"module","creationDate":"January 2015","author":"Thomas Papin","copyright":"","authorEmail":"support@juloa.com","authorUrl":"www.Juloa.com","version":"3.0.3","description":"Displays the latest \\/ random \\/ popular AdsManager ads in a Table","group":"","filename":"mod_adsmanager_table"}', '{"nb_ads":"3","random":"0","catselect":"","cache":"1","cache_time":"900","cachemode":"static","rootid":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10008, 'Adsmanager - JComments', 'plugin', 'jcomments', 'adsmanagercontent', 0, 0, 1, 0, '{"name":"Adsmanager - JComments","type":"plugin","creationDate":"January 2015","author":"Juloa","copyright":"Copyright (C) 2005 - 2011 Open Source Matters. All rights reserved.","authorEmail":"support@juloa.com","authorUrl":"www.Juloa.com","version":"3.0.3","description":"JComments Adsmanager Integration","group":"","filename":"jcomments"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10009, 'AdsManagerContent - Captcha', 'plugin', 'captcha', 'adsmanagercontent', 0, 0, 1, 0, '{"name":"AdsManagerContent - Captcha","type":"plugin","creationDate":"January 2015","author":"Juloa","copyright":"Copyright (C) 2011 ITPrism.com. All rights reserved.","authorEmail":"support@juloa.com","authorUrl":"http:\\/\\/www.Juloa.com","version":"3.0.3","description":"\\n    Captcha for Adsmanager\\n    ","group":"","filename":"captcha"}', '[]', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10010, 'AdsManagerContent - ReCaptcha', 'plugin', 'recaptcha', 'adsmanagercontent', 0, 0, 1, 0, '{"name":"AdsManagerContent - ReCaptcha","type":"plugin","creationDate":"December 2011","author":"Juloa","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"","authorUrl":"","version":"2.5.0","description":"ReCaptcha for Adsmanager (Adaptation of Joomla Plugin)","group":"","filename":"recaptcha"}', '{"public_key":"","private_key":"","theme":"clean"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10011, 'AdsManagerContent - Social', 'plugin', 'social', 'adsmanagercontent', 0, 0, 1, 0, '{"name":"AdsManagerContent - Social","type":"plugin","creationDate":"January 2015","author":"Juloa","copyright":"Copyright (C) 2011 Juloa.com. All rights reserved.","authorEmail":"support@juloa.com","authorUrl":"http:\\/\\/www.Juloa.com","version":"3.0.3","description":"\\n    Adaptation of ITPShare plugin for Adsmanager (Original code From Todor Iliev,ITPrism.com)\\n    ","group":"","filename":"social"}', '{"position":"2","@spacer1":"############# TWITTER SETTINGS #############","twitterButton":"0","twitterName":"","twitterCounter":"horizontal","twitterLanguage":"0","@spacer2":"############# FACEBOOK SHARE ME SETTINGS #############","facebookShareMeButton":"0","facebookShareMeType":"small","facebookShareMeBadgeText":"FFFFFF","facebookShareMeBadge":"3B5998","@spacer4":"############# FACEBOOK LIKE SETTINGS #############","facebookLikeButton":"0","facebookLikeRenderer":"1","facebookLikeAction":"like","facebookLikeType":"button_count","facebookLikeFaces":"0","facebookLikeColor":"light","facebookLikeFont":"","facebookLikeWidth":"90","fbDynamicLocale":"0","fbLocale":"en_US","@spacer5":"############# DIGG SETTINGS #############","diggButton":"0","diggType":"DiggCompact","@spacer6":"############# STUMBLEUPON SETTINGS #############","stumbleButton":"0","stumbleType":"1","@spacer7":"############# LINKEDIN SETTINGS #############","linkedInButton":"0","linkedInType":"right","@spacer8":"############# BUZZ SETTINGS #############","buzzButton":"0","buzzType":"small-count","buzzLocale":"en","@spacer9":"############# RETWEETME SETTINGS #############","retweetmeButton":"0","retweetmeType":"compact","@spacer10":"############# YAHOO BUZZ SETTINGS #############","yahooBuzzButton":"0","yahooBuzzType":"small-votes","@spacer11":"############# GOOGLE PLUS ONE SETTINGS #############","plusButton":"0","plusType":"medium","plusLocale":"en","@spacer12":"############# FACEBOOK LIKE ADVANCED SETTINGS #############","facebookLikeAppId":"","facebookLikeSend":"0","facebookRootDiv":"1","facebookLoadJsLib":"1","@spacer13":"############# EXTRA BUTTONS #############","ebuttons1":"","ebuttons2":"","ebuttons3":"","ebuttons4":"","ebuttons5":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10012, 'Akeeba Subscriptions - AdsMAnager - Publish or unpublish ads following the subscriptions', 'plugin', 'adsmanager', 'akeebasubs', 0, 0, 1, 0, '{"name":"Akeeba Subscriptions - AdsMAnager - Publish or unpublish ads following the subscriptions","type":"plugin","creationDate":"April 2014","author":"Juloa","copyright":"Copyright (c)2012-2014 Juloa","authorEmail":"webmaster@Juloa.com","authorUrl":"http:\\/\\/www.Juloa.com","version":"1.0","description":"PLG_AKEEBASUBS_ADSMANAGER_DESCRIPTION","group":"","filename":"adsmanager"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10013, 'Adsmanager Disclaimer', 'plugin', 'adsmanager_disclaimer', 'system', 0, 0, 1, 0, '{"name":"Adsmanager Disclaimer","type":"plugin","creationDate":"July 2012","author":"Adonay R. M.","copyright":"Copyright (C) 2012 Adonay R. M. All Rights Reserved.","authorEmail":"contentdisclaimer@adonay.name","authorUrl":"http:\\/\\/adonay.name\\/","version":"1.0","description":"Disclaimer per categories for AdsManager","group":"","filename":"adsmanager_disclaimer"}', '{"align":"0","warningtext":"1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_finder_filters`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_filters` (
...
--
-- Table structure for table `yy4cv_finder_links`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links` (
...
--
-- Table structure for table `yy4cv_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms0` (
...
--
-- Table structure for table `yy4cv_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `yy4cv_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `yy4cv_finder_taxonomy`
--

INSERT INTO `yy4cv_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `yy4cv_finder_terms`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_terms` (
...
--
-- Table structure for table `yy4cv_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `yy4cv_finder_terms_common`
--

INSERT INTO `yy4cv_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `yy4cv_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `yy4cv_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `yy4cv_finder_types`
--

CREATE TABLE IF NOT EXISTS `yy4cv_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_languages`
--

CREATE TABLE IF NOT EXISTS `yy4cv_languages` (
...
--
-- Dumping data for table `yy4cv_languages`
--

INSERT INTO `yy4cv_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_menu`
--

CREATE TABLE IF NOT EXISTS `yy4cv_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `yy4cv_menu`
--

INSERT INTO `yy4cv_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(101, 'mainmenu', 'Home', 'home', '', 'home', 'index.php?option=com_adsmanager&view=front&rootid=0', 'component', 1, 1, 1, 10003, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 41, 42, 1, '*', 0),
(102, 'main', 'COM_ADSMANAGER', 'com-adsmanager', '', 'com-adsmanager', 'index.php?option=com_adsmanager', 'component', 0, 1, 1, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/adsmanager-16.png', 0, '{}', 43, 62, 0, '', 1),
(103, 'main', 'COM_ADSMANAGER_CONFIGURATION', 'com-adsmanager-configuration', '', 'com-adsmanager/com-adsmanager-configuration', 'index.php?option=com_adsmanager&c=configuration', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adsconfig.png', 0, '{}', 44, 45, 0, '', 1),
(104, 'main', 'COM_ADSMANAGER_FIELDS', 'com-adsmanager-fields', '', 'com-adsmanager/com-adsmanager-fields', 'index.php?option=com_adsmanager&c=fields', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adsfield.png', 0, '{}', 46, 47, 0, '', 1),
(105, 'main', 'COM_ADSMANAGER_COLUMNS', 'com-adsmanager-columns', '', 'com-adsmanager/com-adsmanager-columns', 'index.php?option=com_adsmanager&c=columns', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adscolumns.png', 0, '{}', 48, 49, 0, '', 1),
(106, 'main', 'COM_ADSMANAGER_AD_DISPLAY', 'com-adsmanager-ad-display', '', 'com-adsmanager/com-adsmanager-ad-display', 'index.php?option=com_adsmanager&c=positions', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adspositions.png', 0, '{}', 50, 51, 0, '', 1),
(107, 'main', 'COM_ADSMANAGER_CATEGORIES', 'com-adsmanager-categories', '', 'com-adsmanager/com-adsmanager-categories', 'index.php?option=com_adsmanager&c=categories', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adscategory.png', 0, '{}', 52, 53, 0, '', 1),
(108, 'main', 'COM_ADSMANAGER_CONTENTS', 'com-adsmanager-contents', '', 'com-adsmanager/com-adsmanager-contents', 'index.php?option=com_adsmanager&c=contents', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adscontent.png', 0, '{}', 54, 55, 0, '', 1),
(109, 'main', 'COM_ADSMANAGER_PLUGINS', 'com-adsmanager-plugins', '', 'com-adsmanager/com-adsmanager-plugins', 'index.php?option=com_adsmanager&c=plugins', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adsplugins.png', 0, '{}', 56, 57, 0, '', 1),
(110, 'main', 'COM_ADSMANAGER_FIELD_IMAGES', 'com-adsmanager-field-images', '', 'com-adsmanager/com-adsmanager-field-images', 'index.php?option=com_adsmanager&c=fieldimages', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adsimages.png', 0, '{}', 58, 59, 0, '', 1),
(111, 'main', 'COM_ADSMANAGER_MAILS', 'com-adsmanager-mails', '', 'com-adsmanager/com-adsmanager-mails', 'index.php?option=com_adsmanager&c=mails', 'component', 0, 102, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_adsmanager/images/menu/adstools.png', 0, '{}', 60, 61, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_menu_types`
--

CREATE TABLE IF NOT EXISTS `yy4cv_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `yy4cv_menu_types`
--

INSERT INTO `yy4cv_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_messages`
--

CREATE TABLE IF NOT EXISTS `yy4cv_messages` (
...
--
-- Table structure for table `yy4cv_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `yy4cv_messages_cfg` (
...
--
-- Table structure for table `yy4cv_modules`
--

CREATE TABLE IF NOT EXISTS `yy4cv_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `yy4cv_modules`
--

INSERT INTO `yy4cv_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 55, 'mod_adsmanager_ads', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '2016-04-17 19:23:43', '0000-00-00 00:00:00', 1, 'mod_adsmanager_ads', 1, 1, '', 0, '*'),
(88, 56, 'mod_adsmanager_menu', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '2016-04-17 19:23:19', '0000-00-00 00:00:00', 1, 'mod_adsmanager_menu', 1, 1, '', 0, '*'),
(89, 57, 'mod_adsmanager_search', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '2016-04-17 19:23:35', '0000-00-00 00:00:00', 1, 'mod_adsmanager_search', 1, 1, '', 0, '*'),
(90, 58, 'mod_adsmanager_table', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '2016-04-17 19:23:27', '0000-00-00 00:00:00', 1, 'mod_adsmanager_table', 1, 1, '', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_modules_menu`
--

CREATE TABLE IF NOT EXISTS `yy4cv_modules_menu` (
...
--
-- Dumping data for table `yy4cv_modules_menu`
--

INSERT INTO `yy4cv_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `yy4cv_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `yy4cv_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_overrider`
--

CREATE TABLE IF NOT EXISTS `yy4cv_overrider` (
...
--
-- Table structure for table `yy4cv_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `yy4cv_postinstall_messages` (
...
--
-- Dumping data for table `yy4cv_postinstall_messages`
--

INSERT INTO `yy4cv_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `yy4cv_redirect_links`
--

CREATE TABLE IF NOT EXISTS `yy4cv_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_schemas`
--

CREATE TABLE IF NOT EXISTS `yy4cv_schemas` (
...
--
-- Dumping data for table `yy4cv_schemas`
--

INSERT INTO `yy4cv_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.5.1-2016-03-29');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_session`
--

CREATE TABLE IF NOT EXISTS `yy4cv_session` (
...
--
-- Dumping data for table `yy4cv_session`
--

INSERT INTO `yy4cv_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('7grmiss5i7usebpqipuhdonpm1', 0, 0, '1460921979', 'joomla|s:2424:"";', 86, 'admin'),
('o4l55u9oa3sjqlsikp5kgn3fu1', 1, 0, '1460921107', 'joomla|s:7168:"";', 86, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_tags`
--

CREATE TABLE IF NOT EXISTS `yy4cv_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `yy4cv_tags`
--

INSERT INTO `yy4cv_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `yy4cv_template_styles`
--

CREATE TABLE IF NOT EXISTS `yy4cv_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `yy4cv_template_styles`
--

INSERT INTO `yy4cv_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `yy4cv_ucm_base`
--

CREATE TABLE IF NOT EXISTS `yy4cv_ucm_base` (
...
--
-- Table structure for table `yy4cv_ucm_content`
--

CREATE TABLE IF NOT EXISTS `yy4cv_ucm_content` (
...
--
-- Table structure for table `yy4cv_ucm_history`
--

CREATE TABLE IF NOT EXISTS `yy4cv_ucm_history` (
...
--
-- Table structure for table `yy4cv_updates`
--

CREATE TABLE IF NOT EXISTS `yy4cv_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Available Updates' AUTO_INCREMENT=66 ;

--
-- Dumping data for table `yy4cv_updates`
--

INSERT INTO `yy4cv_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(3, 3, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '3.5.0.1', '', 'http://update.joomla.org/language/details3/ro-RO_details.xml', '', ''),
(4, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', '', ''),
(5, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.5.0.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', '', ''),
(6, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(7, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.3.1.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', '', ''),
(8, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(9, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(10, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
...
(19, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(20, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(21, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(22, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.5.0.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(23, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.5.0.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(24, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(25, 3, 0, 'Khmer', '', 'pkg_km-KH', 'package', '', 0, '3.4.5.1', '', 'http://update.joomla.org/language/details3/km-KH_details.xml', '', ''),
(26, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
...
(29, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(30, 3, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/nn-NO_details.xml', '', ''),
(31, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(32, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.5.0.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(33, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(34, 3, 10002, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.5.0.6', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(35, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(36, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.5.1.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(37, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(38, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(39, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.5.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(40, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.5.1.2', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(41, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(42, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(43, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
...
(47, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(48, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.5.0.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(49, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
...
(55, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(56, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(57, 3, 0, 'English CA', '', 'pkg_en-CA', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
...
(62, 3, 0, 'Turkmen', '', 'pkg_tk-TM', 'package', '', 0, '3.5.0.1', '', 'http://update.joomla.org/language/details3/tk-TM_details.xml', '', ''),
(63, 3, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/ga-IE_details.xml', '', ''),
(64, 3, 0, 'Dzongkha', '', 'pkg_dz-BT', 'package', '', 0, '3.4.5.1', '', 'http://update.joomla.org/language/details3/dz-BT_details.xml', '', ''),
(65, 3, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.5.1.1', '', 'http://update.joomla.org/language/details3/sl-SI_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_update_sites`
--

CREATE TABLE IF NOT EXISTS `yy4cv_update_sites` (
...
--
-- Dumping data for table `yy4cv_update_sites`
--

INSERT INTO `yy4cv_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1460921106, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1460921106, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1460921104, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1460921104, '');

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `yy4cv_update_sites_extensions` (
...
--
-- Dumping data for table `yy4cv_update_sites_extensions`
--

INSERT INTO `yy4cv_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(3, 10002),
...
--
-- Table structure for table `yy4cv_usergroups`
--

CREATE TABLE IF NOT EXISTS `yy4cv_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `yy4cv_usergroups`
--

INSERT INTO `yy4cv_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `yy4cv_users`
--

CREATE TABLE IF NOT EXISTS `yy4cv_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `yy4cv_users`
--

INSERT INTO `yy4cv_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(86, 'Super User', 'admin', 'mixas.8383@gmail.com', '$2y$10$7wxQ4Q1YRBuR94xVlR1aQ.2aiyfIe2pzC0.1G.QZ5.vHgfF1KRltS', 0, 1, '2016-04-17 18:35:24', '2016-04-17 19:21:18', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_user_keys`
--

CREATE TABLE IF NOT EXISTS `yy4cv_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `yy4cv_user_notes`
--

CREATE TABLE IF NOT EXISTS `yy4cv_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `yy4cv_user_profiles`
--

CREATE TABLE IF NOT EXISTS `yy4cv_user_profiles` (
...
--
-- Table structure for table `yy4cv_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `yy4cv_user_usergroup_map` (
...
--
-- Dumping data for table `yy4cv_user_usergroup_map`
--

INSERT INTO `yy4cv_user_usergroup_map` (`user_id`, `group_id`) VALUES
(86, 8);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `yy4cv_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `yy4cv_utf8_conversion`
--

INSERT INTO `yy4cv_utf8_conversion` (`converted`) VALUES
(1);

-- --------------------------------------------------------

--
-- Table structure for table `yy4cv_viewlevels`
--

CREATE TABLE IF NOT EXISTS `yy4cv_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `yy4cv_viewlevels`
--

INSERT INTO `yy4cv_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
